defmodule DataDiode.ProtocolDefinitions do
  ...
  def matches?(:modbus, <<_trans_id::binary-2, 0x00, 0x00, _len::binary-2, _unit_id::binary-1, _rest::binary>>), do: true
  ...
  def matches?(:mqtt, <<packet_type::size(4), _flags::size(4), _rest::binary>>) when packet_type >= 1 and packet_type <= 14, do: true
